...
;; This has been slightly modified to allow automatic toggling.
;; Since, as a rube, I don't know how to coerce that data from
;; color theme.
...
(defvar solarize-theme-current nil)
...
Ported to Emacs by Greg Pfeil, http://ethanschoonover.com/solarized."
  ...
  (flet ((find-color (name)
    ...
    (let ((base03  (find-color 'base03))
      ...
      (setq solarize-theme-current mode)
      (color-theme-install
